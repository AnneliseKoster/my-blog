...
# Introduction
1 paragraph
describe the dataset, how the data was collected, give a big picture overview of the data and the questions you are trying to answer.Talk about the source of the data and identify what you want to test
...
2-3 paragraphs and 1-2 figures
summary statistics and visualizations showing the relationship between variables
...
3-4 paragraphs and figures
state questions you want to answer and describe the steps you took to answer them
...
explain weaknesses/challenges with the data - what issues are there? What changes would you make to the data set? Are there any issues with could affect your conclusions?
